...
public:
	...
	virtual void		RenderView(const C_ViewSetup& view, int nClearFlags, int whatToDraw) = 0;
	...
	virtual const C_ViewSetup* GetPlayerViewSetup(void) const = 0;
	virtual const C_ViewSetup* GetViewSetup(void) const = 0;
	...
	virtual void		QueueOverlayRenderView(const C_ViewSetup& view, int nClearFlags, int whatToDraw) = 0;
	...
	virtual bool		UpdateShadowDepthTexture(ITexture* pRenderTarget, ITexture* pDepthTexture, const C_ViewSetup& shadowView) = 0;
