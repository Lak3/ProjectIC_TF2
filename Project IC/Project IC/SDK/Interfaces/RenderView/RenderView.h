...
public:
	...
	virtual Color_t			GetLightAtPoint(Vec3& pos) = 0;
	...
	virtual void			DrawBrushModelShadowDepth(IClientEntity* pBaseEnt, model_t* oModel, const Vec3& vOrigin, const Vec3& vAngles, ERenderDepthMode DepthMode) = 0;
	...
	virtual void			GetMatricesForView(const C_ViewSetup& view, VMatrix* pWorldToView, VMatrix* pViewToProjection, VMatrix* pWorldToProjection, VMatrix* pWorldToPixels) = 0;
	virtual void			DrawBrushModelEx(IClientEntity* baseentity, model_t* model, const Vec3& origin, const Vec3& angles, DrawBrushModelMode_t mode) = 0;
};
